"use strict";
// ── POLYFILLS (Required for PDF libraries on Vercel) ─────────────────────────
...
// pdf-parse, pdfkit, and nodemailer moved to lazy-loading in routes to prevent Vercel startup crashes

// Email configuration moved into the route to satisfy serverless cold starts
